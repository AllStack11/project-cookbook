...
describe("urlValidator", () => {
  describe("validateUrl", () => {
    ...
    it("should reject YouTube URL without video ID", () => {
      const result = validateUrl("https://www.youtube.com/watch");
      expect(result.isValid).toBe(false);
  ...
  describe("isSocialMediaUrl", () => {
    it("should return true for social media URLs", () => {
      expect(isSocialMediaUrl("https://www.instagram.com/p/ABC123/")).toBe(
        true
      );
      expect(isSocialMediaUrl("https://www.tiktok.com/@user/video/123")).toBe(
        true
      );
      expect(isSocialMediaUrl("https://twitter.com/user/status/123")).toBe(
        true
      );
    ...
    it("should return false for non-social media URLs", () => {
      ...
      expect(isSocialMediaUrl("https://www.youtube.com/watch?v=123")).toBe(
        false
      );
    });
